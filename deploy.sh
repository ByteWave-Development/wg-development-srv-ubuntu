...
echo -e "  ${GREEN}•${NC} WireGuard UI → ${CYAN}https://$WG_UI_DOMAIN:$WG_UI_PROXY_PORT${NC}"
echo ""
...
echo -e "    Usuario: ${WHITE}$MYSQL_DEV_USER${NC}"
echo -e "    Password: ${WHITE}$MYSQL_DEV_PASSWORD${NC}"
echo ""
echo -e "${BOLD}${CYAN}═══════════════════════════════════════════════════════════${NC}"
...
echo -e "${BOLD}${CYAN}═══════════════════════════════════════════════════════════${NC}"
echo ""
echo -e "  ${GREEN}1.${NC} Conéctate a WireGuard UI: ${CYAN}https://$WG_UI_DOMAIN:$WG_UI_PROXY_PORT${NC}"
